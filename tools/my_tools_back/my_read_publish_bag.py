...
def find_buffered_pts_imgs():
    ...
    len2 = len(fifo_pts)
    if(len1!=[IMG_FIFO_LEN,IMG_FIFO_LEN,IMG_FIFO_LEN,IMG_FIFO_LEN,IMG_FIFO_LEN,IMG_FIFO_LEN]) or (len2 !=2):
        return None, None
